...
/////
    ...
    private String getTodaysDate() {
        ...
        Log.w("xxx", String.valueOf(todaysDate));
    ...
    public class signature extends View {
        ...
        public void save(View v) {
            Log.v("xxx", "Width: " + v.getWidth());
            Log.v("xxx", "Height: " + v.getHeight());
            if (mBitmap == null) {
            ...
            try {
                ...
                String url = Images.Media.insertImage(getContentResolver(), mBitmap, "xxx", null);
                Log.v("xxx", "url: " + url);

            } catch (Exception e) {
                Log.v("xxx", e.toString());
            }
////
            Uri uri = Uri.parse(tempDir);
